...
<div class="info-title-wrap wrap">
	<h2 id="note-title-type">发布寻物信息</h2>
	<span class="fr info-list-more" id="switchType">
			<a href="goods!publish?type=find">发布招领信息</a>
	</span>
...
<div class="wrap post">
	...
	<div class="post-input-wrap">
		...
		<div class="note-info">
			<ul class="clearfix">
				...
				<li class="note-info-item clearfix fl pr">
					<label for="datepicker">丢失时间：</label>
				...
				<li class="note-info-item fr pr">				
					<label for="note-info-address">丢失地点：</label>
		...
		<div class="note-content clearfix" id="content-text">
			...
			<button  type="submit"  class="btn" id="post-submitBotton" >发布信息</button>
