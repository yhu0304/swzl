...
<div class="wrap note-list-page">
	<div class="info-list-wrap">
		<div class="info-title-wrap">
			<h2 id="search-list-title">所有招领信息</h2>
			<h3 id="serach-list-goodsType">
							</h3>
			<span class="info-list-more fr" id="switchType">
				<a href="goods!lost">所有寻物信息</a>
			</span>
		</div>
		
		<ul class='info-list'>
		<li class='clearfix'><span class='info-goods-type'>物品类别</span><span class='info-goods'>捡到物品</span><span class='info-goods'>捡到地点</span><span class='info-goods'>捡到时间</span><span class='info-title'>标题</span></li>
