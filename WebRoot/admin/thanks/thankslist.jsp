...
<thead><tr><th width="40">ID</th><th width="100">用户</th><th width="110">标题</th><th  width="120">操作</th></tr></thead>
<tbody>

<c:forEach items="${list}" var="bean">
<tr><td align="center">${bean.id}</td>
<td align="center">${bean.createuser.username}</td>
<td align="center"><a href="../thanks!view?id=${bean.id}" target="_blank">${bean.title}</a></td>
<td align="center"><!--<a href="method!thanksedit?id=${bean.id}">修改</a> | --><a href="method!thanksdelete?id=${bean.id}" onclick="return confirm('确定删除')">删除</a></td></tr>
</c:forEach>
